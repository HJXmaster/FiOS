...
public class writeFile {
    ...
    Button btnCancel;
    Instances instance;
    public writeFile(final Stage stg,Instances instance) {
        btnOK = new Button();
...
//Set the owner of the Stage 
        ...
        contentForFile.setPromptText("请在这里写下你要说的话...");
...
//                createFile hsy = new createFile(stg);
                ...
                try {
                  instance.writeFile(paths, contentForFile.getText(), intBytes);
                                     new tipBox(stg,"写入成功！");    
                    stage.close();
