...
public class deleteFile {
    ...
    Button btnCancel;
    Instances instance;
    public deleteFile(final Stage stg,Instances instance) {
        btnOK = new Button();
...
//                createFile hsy = new createFile(stg);
        ...
        root.getChildren().addAll(btnOK,btnCancel,path,textForPath,line);
